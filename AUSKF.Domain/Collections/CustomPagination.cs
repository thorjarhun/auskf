namespace AUSKF.Domain.Collections
{
    ...
    public sealed class CustomPagination<T> : BasePagination, IPagination<T>
    {
        ...
        /// <value> </value>
        /// <remarks>
        ///     The setter is only on this property to allow the <see cref="DataContractSerializer" /> to serialize this object. If
        ///     the setter is explicitly used in consumers, then all bets are off!
        /// </remarks>
        ...
        private void BuildPageArrayComplete(IAsyncResult iar)
        {
            if (iar == null)
            {
                throw new ParameterNullException("iar");
            }
        ...
        /// <exception cref="OverflowException" accessor="get">
        ///     <paramref>
        ///         <name>value</name>
        ///     </paramref>
        ...
        /// <remarks>
        ///     If you override the setter of this property in a derived class, then you MUST either recreate the logic in this
        ///     base class or ensure that call base.PageArraySize = x in your derived class, failure to do so <b>WILL</b> result in
