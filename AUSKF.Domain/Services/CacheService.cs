namespace AUSKF.Domain.Services
{
    using System;
    ...
    public sealed class CacheService : ICacheService
    {
        ...
        public CacheService(ICacheItemPropertiesFactory cacheItemsPropertiesFactory = null)
        {
            this.cacheItemsPropertiesFactory = cacheItemsPropertiesFactory ?? new CacheItemPropertiesFactory();
            this.Initialize();
        }
        ...
        public Task<T> TryGetAsync<T>(string key, Func<T> serviceFunc, ICacheItemProperties cacheItemProperties)
        {
            if (serviceFunc == null)
            {
                throw new ArgumentNullException("serviceFunc");
            ...
            return this.Contains(key) ?
                Task.FromResult((T)this.cache[key]) :
                Task<T>.Factory.FromAsync(serviceFunc.BeginInvoke, serviceFunc.EndInvoke, null).ContinueWith(tt => tt.Result);
        }
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        public Task<T> TryGetAsync<T1, T>(string key, T1 t1, Func<T1, T> serviceFunc, ICacheItemProperties properties)
        {
            if (serviceFunc == null)
            {
                throw new ArgumentNullException("serviceFunc");
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        public Task<T> TryGetAsync<T1, T2, T>(string key, T1 t1, T2 t2, Func<T1, T2, T> serviceFunc, ICacheItemProperties properties)
        {
            if (serviceFunc == null)
            {
                throw new ArgumentNullException("serviceFunc");
            ...
            var tcs = new TaskCompletionSource<T>();
            serviceFunc.BeginInvoke(t1, t2, iar =>
            {
                try
                {
                    tcs.TrySetResult(serviceFunc.EndInvoke(iar));
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        public Task<T> TryGetAsync<T1, T2, T3, T>(string key, T1 t1, T2 t2, T3 t3,
            Func<T1, T2, T3, T> serviceFunc, ICacheItemProperties properties)
        {
            if (serviceFunc == null)
            {
            ...
            var tcs = new TaskCompletionSource<T>();
            serviceFunc.BeginInvoke(t1, t2, t3, iar =>
            {
                try
                {
                    tcs.TrySetResult(serviceFunc.EndInvoke(iar));
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        public Task<T> TryGetAsync<T1, T2, T3, T4, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4,
            Func<T1, T2, T3, T4, T> serviceFunc, ICacheItemProperties properties)
        {
            ...
            var tcs = new TaskCompletionSource<T>();
            serviceFunc.BeginInvoke(t1, t2, t3, t4, iar =>
            {
                try
                {
                    tcs.TrySetResult(serviceFunc.EndInvoke(iar));
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        public Task<T> TryGetAsync<T1, T2, T3, T4, T5, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5,
            Func<T1, T2, T3, T4, T5, T> serviceFunc, ICacheItemProperties properties)
        {
            ...
            var tcs = new TaskCompletionSource<T>();
            serviceFunc.BeginInvoke(t1, t2, t3, t4, t5, iar =>
            {
                try
                {
                    tcs.TrySetResult(serviceFunc.EndInvoke(iar));
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        public Task<T> TryGetAsync<T1, T2, T3, T4, T5, T6, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6,
            Func<T1, T2, T3, T4, T5, T6, T> serviceFunc, ICacheItemProperties properties)
        {
            if (serviceFunc == null)
            {
            ...
            var tcs = new TaskCompletionSource<T>();
            serviceFunc.BeginInvoke(t1, t2, t3, t4, t5, t6, iar =>
            {
                try
                {
                    tcs.TrySetResult(serviceFunc.EndInvoke(iar));
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        public Task<T> TryGetAsync<T1, T2, T3, T4, T5, T6, T7, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7,
            Func<T1, T2, T3, T4, T5, T6, T7, T> serviceFunc, ICacheItemProperties properties)
        {
            if (serviceFunc == null)
            {
            ...
            var tcs = new TaskCompletionSource<T>();
            serviceFunc.BeginInvoke(t1, t2, t3, t4, t5, t6, t7, iar =>
            {
                try
                {
                    tcs.TrySetResult(serviceFunc.EndInvoke(iar));
