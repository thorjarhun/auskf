namespace AUSKF.Domain.Services.Interfaces
{
    ...
    public interface ICacheService : ISingletonLifestyle
    {
        /// <summary>
        ...
        T TryGet<T>(string key, Func<T> serviceFunc, ICacheItemProperties cacheItemProperties);
        ...
        /// <param name="cacheItemProperties">The cache item properties.</param>
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T>(string key, Func<T> serviceFunc, ICacheItemProperties cacheItemProperties);
        ...
        /// <returns></returns>
        T TryGet<T1, T>(string key, T1 t1, Func<T1, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T1, T>(string key, T1 t1, Func<T1, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <param name="properties">The properties.</param>
        /// <returns></returns>
        T TryGet<T1, T2, T>(string key, T1 t1, T2 t2, Func<T1, T2, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T1, T2, T>(string key, T1 t1, T2 t2, Func<T1, T2, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <param name="properties">The properties.</param>
        /// <returns></returns>
        T TryGet<T1, T2, T3, T>(string key, T1 t1, T2 t2, T3 t3,
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T1, T2, T3, T>(string key, T1 t1, T2 t2, T3 t3,
            Func<T1, T2, T3, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <param name="properties">The properties.</param>
        /// <returns></returns>
        T TryGet<T1, T2, T3, T4, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, Func<T1, T2, T3, T4, T> serviceFunc,
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T1, T2, T3, T4, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4,
            Func<T1, T2, T3, T4, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <param name="properties">The properties.</param>
        /// <returns></returns>
        T TryGet<T1, T2, T3, T4, T5, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, Func<T1, T2, T3, T4, T5, T> serviceFunc,
            ICacheItemProperties properties);
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T1, T2, T3, T4, T5, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5,
            Func<T1, T2, T3, T4, T5, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <param name="properties">The properties.</param>
        /// <returns></returns>
        T TryGet<T1, T2, T3, T4, T5, T6, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6,
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T1, T2, T3, T4, T5, T6, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6,
            Func<T1, T2, T3, T4, T5, T6, T> serviceFunc, ICacheItemProperties properties);
        ...
        /// <param name="properties">The properties.</param>
        /// <returns></returns>
        T TryGet<T1, T2, T3, T4, T5, T6, T7, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7,
        ...
        /// <returns></returns>
        /// <exception cref="System.ArgumentNullException">serviceFunc</exception>
        Task<T> TryGetAsync<T1, T2, T3, T4, T5, T6, T7, T>(string key, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7,
            Func<T1, T2, T3, T4, T5, T6, T7, T> serviceFunc, ICacheItemProperties properties);
